...
# Defaults already size k3s-srv1 (2 vCPU / 4 GB / 40 GB, 192.168.68.25) and
# k3s-agent1/k3s-agent2 (2 vCPU / 4 GB / 40 GB, 192.168.68.26-.27) — sized against
# pve1's live capacity (16 vCPU / 62.5 GB, ~13 vCPU / 35 GB already
# allocated to the core/elastic VMs). Override k3s_server_nodes/
